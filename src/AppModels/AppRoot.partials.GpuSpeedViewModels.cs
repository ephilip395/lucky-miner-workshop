    ...
    public static partial class AppRoot
    {
        public class GpuSpeedViewModels : ViewModelBase
        {
            ...
            private GpuSpeedViewModels()
            {
                ...
                this.GpuAllVm = GpuVms.Items.FirstOrDefault(a => a.Index == LuckyContext.GpuAllId);
                ...
                _totalSpeedVm = this._list.FirstOrDefault(a => a.GpuVm.Index == LuckyContext.GpuAllId);
                        ...
                        if (index == _totalSpeedVm.GpuVm.Index)
                        {
                            ...
                            else
                            {
                                if (message.IsDual)
                                {
                                    ...
                                    {
                                        IncomePerDay incomePerDay = LuckyContext.Instance.CalcConfigSet.GetIncomePerHashPerDay(dualMineContext.DualCoin.Code);
                                ...
                                {
                                    IncomePerDay incomePerDay = LuckyContext.Instance.CalcConfigSet.GetIncomePerHashPerDay(mineContext.MainCoin.Code);
            ...
            public void Refresh()
            {
                ...
                {
                    var data = LuckyContext.Instance.GpusSpeed.AsEnumerable().FirstOrDefault(a => a.Gpu.Index == item.GpuVm.Index);
                    if (data != null)
                    {
                        if (item.GpuVm.Index == LuckyContext.GpuAllId)
                        {
            ...
            public List<GpuSpeedViewModel> List
            {
                get
                {
                    return _list.Where(a => a.GpuVm.Index != LuckyContext.GpuAllId).ToList();
                }
            }
