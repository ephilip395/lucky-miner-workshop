...
namespace Lucky.MinerMonitor.Vms {
    public class UserPageViewModel : ViewModelBase {
        ...
        public UserPageViewModel() {
            ...
            this.Remove = new DelegateCommandTpl<UserViewModel>(vm => {
            ...
            this.AddAdminRole = new DelegateCommandTpl<UserViewModel>(vm => {
                if (!ClientAppType.IsMinerMonitor) {
                    return;
                }
                if (string.IsNullOrEmpty(vm.LoginName)) {
            ...
            this.RemoveAdminRole = new DelegateCommandTpl<UserViewModel>(vm => {
                if (!ClientAppType.IsMinerMonitor) {
                    return;
                }
                if (string.IsNullOrEmpty(vm.LoginName)) {
