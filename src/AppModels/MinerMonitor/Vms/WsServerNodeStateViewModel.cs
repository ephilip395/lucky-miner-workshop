...
namespace Lucky.MinerMonitor.Vms {
    public class WsServerNodeStateViewModel : ViewModelBase, IWsServerNode {
        ...
        public WsServerNodeStateViewModel(IWsServerNode data) {
            ...
            _minerClientWsSessionCount = data.MinerTweakWsSessionCount;
            _minerStudioWsSessionCount = data.MinerMonitorWsSessionCount;
            _minerClientSessionCount = data.MinerTweakSessionCount;
            _minerStudioSessionCount = data.MinerMonitorSessionCount;
            _osInfo = data.OSInfo;
        ...
        public void Update(IVarWsServerNode data) {
            ...
            this.MinerTweakWsSessionCount = data.MinerTweakWsSessionCount;
            this.MinerMonitorWsSessionCount = data.MinerMonitorWsSessionCount;
            this.MinerTweakSessionCount = data.MinerTweakSessionCount;
            this.MinerMonitorSessionCount = data.MinerMonitorSessionCount;
