...
namespace Lucky.MinerMonitor.Vms {
    public class ChangePasswordViewModel : ViewModelBase {
        ...
        public string CaptchaUrl {
            get {
                return $"{RpcRoot.OfficialServerUrlBase}/api/{ControllerUtil.GetControllerName<ICaptchaController<string>>()}/{nameof(ICaptchaController<string>.Get)}?id={ActionCaptchaId}";
            }
        }
    }
}
