...
namespace Lucky.MinerMonitor.Vms {
    public class MinerTweakAddViewModel : ViewModelBase {
        ...
        public MinerTweakAddViewModel() {
            ...
            this.Save = new DelegateCommand(() => {
                ...
                if (this.IsIpRange) {
                    ...
                    MinerMonitorRoot.LocalMinerMonitorService.AddClientsAsync(clientIps, (response, e) => {
                    ...
                    MinerMonitorRoot.LocalMinerMonitorService.AddClientsAsync(new List<string> { this.LeftIp }, (response, e) => {
                        if (!response.IsSuccess()) {
                            VirtualRoot.Out.ShowError(response.ReadMessage(e));
                        }
                        else {
