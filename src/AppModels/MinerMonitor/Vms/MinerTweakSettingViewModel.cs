...
namespace Lucky.MinerMonitor.Vms {
    public class MinerTweakSettingViewModel : ViewModelBase {
        ...
        public MinerTweakSettingViewModel() {
            if (!WpfUtil.IsInDesignMode) {
                throw new InvalidProgramException(LuckyKeyword.WpfDesignOnly);
            }
        }

        public MinerTweakSettingViewModel(MinerTweakViewModel[] minerClients) {
