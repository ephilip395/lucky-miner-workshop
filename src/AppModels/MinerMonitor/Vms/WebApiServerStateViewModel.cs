...
namespace Lucky.MinerMonitor.Vms {
    public class WebApiServerStateViewModel : ViewModelBase, IWebApiServerState {
        ...
        public int MinerTweakWsSessionCount {
            get {
                return WsServerNodeVms.Sum(a => a.MinerTweakWsSessionCount);
            }
        }

        public int MinerTweakSessionCount {
            get {
                return WsServerNodeVms.Sum(a => a.MinerTweakSessionCount);
            }
        }

        public int MinerMonitorWsSessionCount {
            get {
                return WsServerNodeVms.Sum(a => a.MinerMonitorWsSessionCount);
            }
        }

        public int MinerMonitorSessionCount {
            get {
                return WsServerNodeVms.Sum(a => a.MinerMonitorSessionCount);
            }
        }
