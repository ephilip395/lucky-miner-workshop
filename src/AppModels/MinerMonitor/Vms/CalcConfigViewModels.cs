    ...
    public class CalcConfigViewModels : ViewModelBase {
        ...
        public CalcConfigViewModels() {
            ...
            this.Save = new DelegateCommand(() => {
                LuckyContext.Instance.CalcConfigSet.SaveCalcConfigs(this.CalcConfigVms.Select(a => CalcConfigData.Create(a)).ToList());
                VirtualRoot.Execute(new CloseWindowCommand(this.Id));
            });
            this.Clear = new DelegateCommand(() => {
                var coins = LuckyContext.Instance.ServerContext.CoinSet.AsEnumerable();
        ...
        public void Refresh() {
            ...
            foreach (var item in LuckyContext.Instance.CalcConfigSet.AsEnumerable().ToArray()) {
