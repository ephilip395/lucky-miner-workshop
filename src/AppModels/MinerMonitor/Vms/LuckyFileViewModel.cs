...
namespace Lucky.MinerMonitor.Vms {
    public class LuckyFileViewModel : ViewModelBase, ILuckyFile {
        public static readonly LuckyFileViewModel Empty = new LuckyFileViewModel(new LuckyFileData {
            AppType = LuckyAppType.MinerTweak,
        ...
        private Guid _id;
        private LuckyAppType _appType;
        private DateTime _publishOn;
        private string _title;
        private string _description;

        public LuckyFileViewModel(ILuckyFile data) {
            _id = data.Id;
