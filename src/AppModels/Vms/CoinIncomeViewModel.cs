...
namespace Lucky.Vms {
    public class CoinIncomeViewModel : ViewModelBase {
        ...
        public void Refresh() {
            if (LuckyContext.Instance.CalcConfigSet.TryGetCalcConfig(_coinVm, out ICalcConfig calcConfig)) {
                ...
                var incomePerDay = LuckyContext.Instance.CalcConfigSet.GetIncomePerHashPerDay(_coinVm.Code);
        ...
        public SpeedUnitViewModel SpeedUnitVm {
            get {
                if (_speedUnitVm == null && LuckyContext.Instance.CalcConfigSet.TryGetCalcConfig(_coinVm, out ICalcConfig calcConfig)) {
