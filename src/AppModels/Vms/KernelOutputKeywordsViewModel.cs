    ...
    public class KernelOutputKeywordsViewModel : ViewModelBase {
        ...
        public KernelOutputViewModel KernelOutputVm {
            get {
                ...
                if (AppRoot.KernelOutputViewModels.Instance.TryGetKernelOutputVm(LuckyContext.Instance.CurrentMineContext.KernelOutput.GetId(), out KernelOutputViewModel kernelOutputVm)) {
