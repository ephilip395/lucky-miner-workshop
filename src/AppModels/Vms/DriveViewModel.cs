...
namespace Lucky.Vms {
    public class DriveViewModel : ViewModelBase, IDrive {
        ...
        public DriveViewModel(IDrive drive) {
            ...
            this.Set = new DelegateCommandTpl<string>(parameter => {
                double i = double.Parse(parameter);
                if (i == 0) {
                    VirtualMemoryMaxSizeMb = 0;
                }
                else {
                    VirtualMemoryMaxSizeMb = (int)(Math.Pow(2.0, i) * LuckyKeyword.IntK);
                }
            });
        }
        ...
        public double VirtualMemoryMaxSizeGb {
            get {
                return VirtualMemoryMaxSizeMb / LuckyKeyword.DoubleK;
            }
        }
        ...
        public double VirtualMemoryMaxSizeLog2 {
            get {
                ...
                return Math.Log(VirtualMemoryMaxSizeMb / LuckyKeyword.DoubleK, 2);
            }
            set {
                if (value == 0) {
                    ...
                    this.VirtualMemoryMaxSizeMb = (int)(Math.Pow(2, value) * LuckyKeyword.IntK);
                }
                OnPropertyChanged(nameof(VirtualMemoryMaxSizeLog2));
            }
        }
