...
namespace Lucky.Vms {
    public class SpeedChartViewModel : ViewModelBase {
        ...
        public SpeedChartViewModel(GpuSpeedViewModel gpuSpeedVm) {
            ...
            this._axisX = new AxesCollection() {
                new Axis() {
                    ...
                    MaxValue = now.Ticks,
                    MinValue = now.Ticks - TimeSpan.FromMinutes(LuckyContext.SpeedHistoryLengthByMinute).Ticks,
                    Unit=axisUnit,
                    Separator = new Separator() {
                        Step = axisStep
                    }
        ...
        public void SetAxisLimits(DateTime now) {
            ...
            AxisX[0].MinValue = now.Ticks - TimeSpan.FromMinutes(LuckyContext.SpeedHistoryLengthByMinute).Ticks;
