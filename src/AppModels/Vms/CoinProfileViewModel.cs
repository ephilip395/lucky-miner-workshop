    ...
    public class CoinProfileViewModel : ViewModelBase, ICoinProfile
    {
            ...
            this.AddWallet = new DelegateCommand(() =>
            {
                if (AppRoot.CoinVms.TryGetCoinVm(this.CoinId, out CoinViewModel coinVm))
                {
                    ...
                    new WalletViewModel(id)
                    {
                        ...
                        AfterClose = () =>
                        {
                            if (LuckyContext.Instance.MinerProfile.TryGetWallet(id, out IWallet wallet))
                            {
        ...
        public Guid PoolId
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(PoolId), value);
        ...
        public Guid PoolId1
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(PoolId1), value);
        ...
        public string Wallet
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(Wallet), value ?? string.Empty);
                    OnPropertyChanged(nameof(Wallet));
                    // 不必判断该对象是否是主界面上当前展示的对象，因为若不是主界面上当前显式的对象的话没有机会变更
                    LuckyContext.RefreshArgsAssembly.Invoke("币种Profile上放置的挖矿钱包发生了变更");
                }
            }
        }
        ...
        public bool IsHideWallet
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(IsHideWallet), value);
        ...
        public Guid CoinKernelId
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(CoinKernelId), value);
        ...
        public PoolViewModel MainCoinPool
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    // 不必判断该对象是否是主界面上当前展示的对象，因为若不是主界面上当前显式的对象的话没有机会变更
                    LuckyContext.RefreshArgsAssembly.Invoke("币种Profile上引用的主挖币种的主挖矿池发生了切换");
                }
        ...
        public PoolViewModel MainCoinPool1
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    // 不必判断该对象是否是主界面上当前展示的对象，因为若不是主界面上当前显式的对象的话没有机会变更
                    LuckyContext.RefreshArgsAssembly.Invoke("币种Profile上引用的主挖币种的备用矿池发生了切换");
                }
                AppRoot.MinerProfileVm.OnPropertyChanged(nameof(AppRoot.MinerProfileVm.IsAllMainCoinPoolIsUserMode));
            }
        }
        ...
        public Guid DualCoinPoolId
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(DualCoinPoolId), value);
        ...
        public string DualCoinWallet
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(DualCoinWallet), value ?? string.Empty);
                    OnPropertyChanged(nameof(DualCoinWallet));
                    // 不必判断该对象是否是主界面上当前展示的对象，因为若不是主界面上当前显式的对象的话没有机会变更
                    LuckyContext.RefreshArgsAssembly.Invoke("币种Profile上放置的双挖钱包发生了变更");
                }
            }
        }
        ...
        public bool IsDualCoinHideWallet
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(IsDualCoinHideWallet), value);
        ...
        public double CalcInput
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(CalcInput), value);
        ...
        public bool IsLowSpeedRestartComputer
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(IsLowSpeedRestartComputer), value);
        ...
        public int LowSpeedRestartComputerMinutes
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(LowSpeedRestartComputerMinutes), value);
        ...
        public double LowSpeed
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(LowSpeed), value);
        ...
        public bool IsLowSpeedReOverClock
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(IsLowSpeedReOverClock), value);
        ...
        public int LowSpeedReOverClockMinutes
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(LowSpeedReOverClockMinutes), value);
        ...
        public double OverClockLowSpeed
        {
            ...
            set
            {
                ...
                {
                    LuckyContext.Instance.MinerProfile.SetCoinProfileProperty(this.CoinId, nameof(OverClockLowSpeed), value);
        ...
        public PoolViewModel DualCoinPool
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    // 不必判断该对象是否是主界面上当前展示的对象，因为若不是主界面上当前显式的对象的话没有机会变更
                    LuckyContext.RefreshArgsAssembly.Invoke("币种Profile上引用的双挖币种的矿池发生了切换");
                }
            }
        }
    }
