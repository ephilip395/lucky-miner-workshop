    ...
    public class ToolboxViewModel : ViewModelBase {
        ...
        public string BlockWAUHelpUrl {
            get {
                ...
                return LuckyContext.Instance.ServerContext.SysDicItemSet.TryGetDicItemValue(LuckyKeyword.ThisSystemSysDicCode, "BlockWAUHelpUrl", url);
            }
        }
        ...
        public string Win10OptimizeHelpUrl {
            get {
                ...
                return LuckyContext.Instance.ServerContext.SysDicItemSet.TryGetDicItemValue(LuckyKeyword.ThisSystemSysDicCode, "Win10OptimizeHelpUrl", url);
            }
        }
        ...
        public SysDicItemViewModel NvidiaDriverWin10 {
            get {
                if (LuckyContext.Instance.ServerContext.SysDicItemSet.TryGetDicItem(LuckyKeyword.ThisSystemSysDicCode, "NvidiaDriverWin10", out ISysDicItem item)) {
        ...
        public SysDicItemViewModel NvidiaDriverWin7 {
            get {
                if (LuckyContext.Instance.ServerContext.SysDicItemSet.TryGetDicItem(LuckyKeyword.ThisSystemSysDicCode, "NvidiaDriverWin7", out ISysDicItem item)) {
                    if (AppRoot.SysDicItemVms.TryGetValue(item.GetId(), out SysDicItemViewModel vm)) {
                        return vm;
                    }
                }
        ...
        public SysDicItemViewModel NvidiaDriverMore {
            get {
                if (LuckyContext.Instance.ServerContext.SysDicItemSet.TryGetDicItem(LuckyKeyword.ThisSystemSysDicCode, "NvidiaDriverMore", out ISysDicItem item)) {
                    if (AppRoot.SysDicItemVms.TryGetValue(item.GetId(), out SysDicItemViewModel vm)) {
                        return vm;
                    }
                }
        ...
        public SysDicItemViewModel AmdDriverMore {
            get {
                if (LuckyContext.Instance.ServerContext.SysDicItemSet.TryGetDicItem(LuckyKeyword.ThisSystemSysDicCode, "AmdDriverMore", out ISysDicItem item)) {
                    if (AppRoot.SysDicItemVms.TryGetValue(item.GetId(), out SysDicItemViewModel vm)) {
                        return vm;
                    }
                }
        ...
        public SysDicItemViewModel VisualCpp0 {
            get {
                if (LuckyContext.Instance.ServerContext.SysDicItemSet.TryGetDicItem(LuckyKeyword.ThisSystemSysDicCode, "VisualCpp0", out ISysDicItem item)) {
                    if (AppRoot.SysDicItemVms.TryGetValue(item.GetId(), out SysDicItemViewModel vm)) {
                        return vm;
                    }
                }
        ...
        public SysDicItemViewModel VisualCpp1 {
            get {
                if (LuckyContext.Instance.ServerContext.SysDicItemSet.TryGetDicItem(LuckyKeyword.ThisSystemSysDicCode, "VisualCpp1", out ISysDicItem item)) {
                    if (AppRoot.SysDicItemVms.TryGetValue(item.GetId(), out SysDicItemViewModel vm)) {
                        return vm;
                    }
                }
        ...
        public bool IsRemoteDesktopEnabled {
            get {
                return LuckyRegistry.GetIsRdpEnabled();
            }
        }
