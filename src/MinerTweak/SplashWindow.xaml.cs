...
namespace Lucky.Views {
    ...
    public partial class SplashWindow : Window {
        ...
        private SplashWindow() {
            ...
            this.BigLogo.Source = new BitmapImage(new Uri((ClientAppType.IsMinerMonitor ? "/LuckyWpf;component/Styles/Images/cc128.png" : "/LuckyWpf;component/Styles/Images/digger128.png"), UriKind.RelativeOrAbsolute));
