...
namespace Lucky.Vms
{
    public class LoginWindowViewModel : ViewModelBase
    {
        ...
        public LoginWindowViewModel(string serverHost = null)
        {
            ...
            this._loginName = LuckyRegistry.GetLoginName();
            this._isInnerIp = LuckyRegistry.GetMinerMonitorIsInnerIp();
        ...
        public bool IsInnerIp
        {
            ...
            set
            {
                if (_isInnerIp != value)
                {
                    ...
                    if (value)
                    {
                        this._serverHost = LuckyKeyword.Localhost;
                    }
                    else
                    {
                        this._serverHost = RpcRoot.OfficialServerAddress;
                    }
                    LuckyRegistry.SetMinerMonitorIsInnerIp(value);
        ...
        public string LoginName
        {
            ...
            set
            {
                ...
                {
                    _loginName = value;
                    LuckyRegistry.SetLoginName(value);
