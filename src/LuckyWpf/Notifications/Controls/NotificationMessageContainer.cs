...
namespace Lucky.Notifications.Controls
{
    /// <summary>
    ...
    public class NotificationMessageContainer : ItemsControl
    {
        ...
        public static readonly DependencyProperty ManagerProperty =
            DependencyProperty.Register(
                nameof(Manager),
                typeof(INotificationMessageManager),
                typeof(NotificationMessageContainer),
                new PropertyMetadata(null, (dependencyObject, dependencyPropertyChangedEventArgs) =>
                {
        ...
        private void ManagerOnOnMessageDismissed(object sender, NotificationMessageManagerEventArgs args)
        {
            ...
            if (args.Message is INotificationAnimation na)
            {
                var animation = na.AnimationOut;
                if (animation != null &&
                    na.Animates &&
                    na.AnimatableElement != null &&
                    na.AnimationOutDependencyProperty != null)
                {
                    animation.Completed += (s, a) => this.RemoveMessage(args.Message);
                    na.AnimatableElement.BeginAnimation(na.AnimationOutDependencyProperty, animation);
                }
                else
                {
