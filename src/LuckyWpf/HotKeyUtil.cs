...
namespace Lucky {
    public static class HotKeyUtil {
        ...
        public static string GetHotKey() {
            object value = Windows.WinRegistry.GetValue(Registry.Users, LuckyRegistry.LuckyRegistrySubKey, "HotKey");
            if (value == null) {
                return "X";
            }
        ...
        public static bool SetHotKey(string value) {
            ...
            if (Enum.TryParse(value, out System.Windows.Forms.Keys key) && key >= System.Windows.Forms.Keys.A && key <= System.Windows.Forms.Keys.Z) {
                if (RegHotKey.Invoke(key)) {
                    Windows.WinRegistry.SetValue(Registry.Users, LuckyRegistry.LuckyRegistrySubKey, "HotKey", value);
                    return true;
                }
            }
            return false;
