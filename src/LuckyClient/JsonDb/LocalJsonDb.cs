...
namespace Lucky.JsonDb {
    public class LocalJsonDb : ILocalJsonDb {
        public static LocalJsonDb ConvertFromLuckyContext() {
            return new LocalJsonDb(LuckyContext.Instance, new MineWorkData {
        ...
        public LocalJsonDb(ILuckyContext luckycmContext, MineWorkData mineWorkData) {
            ...
            MinerProfile.MinerName = LuckyKeyword.MinerNameParameterName;
            ...
            Pools = luckycmContext.ServerContext.PoolSet.AsEnumerable().Where(a => poolProfiles.Any(b => b.PoolId == a.GetId())).Select(a => new PoolData().Update(a)).ToArray();
