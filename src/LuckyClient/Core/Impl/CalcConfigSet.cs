...
namespace Lucky.Core.Impl
{
    public class CalcConfigSet : ICalcConfigSet
    {
        ...
        public CalcConfigSet(ILuckyContext luckycmContext)
        {
        ...
        public void Init(bool forceRefresh = false)
        {
            ...
            var mineContext = LuckyContext.Instance.CurrentMineContext;
            ...
            if ((_initedOn == DateTime.MinValue || LuckyContext.IsUiVisible || ClientAppType.IsMinerMonitor)
        ...
        private void Init(List<CalcConfigData> data)
        {
            ...
            var list = _luckycmContext.ServerContext.CoinSet.AsEnumerable().OrderBy(a => a.Code).Select(a => new CalcConfigData
            {
                CoinCode = a.Code,
