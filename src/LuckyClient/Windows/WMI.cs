        ...
        public static bool IsWmiEnabled
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        LuckyConsole.DevOk("WMI service seems to be running, ManagementObjectSearcher returned success.");
                        _isWmiEnabled = true;
                    }
                }
                catch
                {
                    LuckyConsole.DevError("ManagementObjectSearcher not working need WMI service to be running");
                    _isWmiEnabled = false;
                }
#if DEBUG
                ...
                {
                    LuckyConsole.DevTimeSpan($"耗时{elapsedMilliseconds} {nameof(WMI)}.IsWmiEnabled");
                }
#endif
                return _isWmiEnabled;
            }
