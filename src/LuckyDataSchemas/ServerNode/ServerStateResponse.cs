...
namespace Lucky.ServerNode {
    ...
    public class ServerStateResponse : IServerStateResponse {
        public static readonly ServerStateResponse Empty = new ServerStateResponse {
            ...
            MinerTweakVersion = string.Empty,
            Time = 0,
            MessageTimestamp = 0,
        ...
        public static ServerStateResponse FromLine(string line) {
            ...
            return new ServerStateResponse {
                ...
                MinerTweakVersion = minerClientVersion,
                Time = time,
        ...
        public string ToLine() {
            return $"{JsonFileVersion}|{MinerTweakVersion}|{Time.ToString()}|{MessageTimestamp.ToString()}|{OutputKeywordTimestamp.ToString()}|{WsStatus.ToString()}|{NeedReClientId.ToString()}";
        }
        ...
        /// <summary>
        /// <see cref="IServerStateResponse.MinerTweakVersion"/>
        /// </summary>
        public string MinerTweakVersion { get; set; }
        /// <summary>
