...
namespace Lucky.Core.MinerMonitor {
    public class ColumnsShowData : IDbEntity<Guid>, IColumnsShow {
        public static readonly ColumnsShowData PleaseSelect = new ColumnsShowData {
            ...
            HighCpuPercent = true,
            HighCpuSeconds = true,
            IsOuterUserEnabled = true,
            IsRaiseHighCpuEvent = true,
            KernelSelfRestartCount = true,
            MACAddress = true,
            OuterUserId = true
        };
        ...
        public bool CpuPerformance { get; set; }
        ...
        public bool HighCpuPercent { get; set; }

        public bool HighCpuSeconds { get; set; }

        public bool KernelSelfRestartCount { get; set; }
