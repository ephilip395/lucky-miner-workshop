...
{
    public partial class MinerTweaksWindow : Window
    {
        private static MinerTweaksWindow _instance = null;
        public static MinerTweaksWindow ShowWindow(bool isToggle)
        {
            if (_instance == null)
            {
                _instance = new MinerTweaksWindow();
                _instance.Show();
            }
            else
            {
